...
{
public:
    virtual void visit(Int128AsgAST& ast) = 0;
    virtual void visit(StopInterpretAST& ast) = 0;
    virtual void visit(OutOperAST& ast) = 0;
    virtual Int128 visitExpr(ExprInt128& ast) = 0;
    virtual Int128 visitExpr(ExprVariable& ast) = 0;
    virtual Int128 visitExpr(ExprSum& ast) = 0;
};
